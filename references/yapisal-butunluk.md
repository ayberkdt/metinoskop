...
Özne: uygulanabilirlik koşulu. Yüklem: dikkate alınmalı. Gerekli niteleme: veri kümesinin yetersiz kalabileceği koşullar. Geri kalan yirmi sözcük çerçeveydi. Akademik ses veriyor diye karmaşıklığı ödüllendirme. Çerçeve adlarının (`açısından`, `kapsamında`, `bağlamında`, `noktasında`, `üzerinden`) hâl eki, iyelik veya fiille değiştirilmesi ve silme testi için [Türkçe ritim ve çeviri kokusu › Çerçeve yığını](turkce-ritim-ve-ceviri-kokusu.md#çerçeve-yığını) bölümüne bak.
